...
public class TestGraphHash {
	...
	public void testCrearGrafo() {
		...
		Assert.assertTrue(grafo.g.isEmpty());
		...
		Assert.assertTrue(grafo.g.get(p1.getNombre()) != null);

		Assert.assertTrue(grafo.g.get(p1.getNombre()).isEmpty());
		...
		Assert.assertTrue(grafo.g.get(a1.getNombre()).contains(p1.getNombre()));

		Assert.assertTrue(grafo.g.get(p1.getNombre()).contains(a1.getNombre()));
		...
		Assert.assertTrue(grafo.g.get(a1.getNombre()).contains(p1.getNombre()));
		Assert.assertTrue(grafo.g.get(a1.getNombre()).contains(p2.getNombre()));
		Assert.assertTrue(grafo.g.get(p1.getNombre()).contains(a1.getNombre()));
		Assert.assertTrue(grafo.g.get(p2.getNombre()).contains(a1.getNombre()));
		...
		Assert.assertTrue(grafo.g.get(a1.getNombre()) != null);
		Assert.assertTrue(grafo.g.get(a1.getNombre()).contains(p1.getNombre()));

		Assert.assertTrue(grafo.g.get(a2.getNombre()) != null);
		Assert.assertTrue(grafo.g.get(a2.getNombre()).contains(p2.getNombre()));

		Assert.assertTrue(grafo.g.get(p1.getNombre()) != null);
		Assert.assertTrue(grafo.g.get(p1.getNombre()).contains(a1.getNombre()));

		Assert.assertTrue(grafo.g.get(p2.getNombre()) != null);
		Assert.assertTrue(grafo.g.get(p2.getNombre()).contains(a2.getNombre()));

		Assert.assertTrue(grafo.g.get(p3.getNombre()) != null);
		Assert.assertTrue(grafo.g.get(p3.getNombre()).isEmpty());
		...
		Assert.assertTrue(grafo.g.get(p1.getNombre()).contains(a1.getNombre()));
		Assert.assertTrue(grafo.g.get(p1.getNombre()).contains(a2.getNombre()));
		Assert.assertTrue(grafo.g.get(p1.getNombre()).contains(a3.getNombre()));
		Assert.assertTrue(grafo.g.get(a1.getNombre()).contains(p1.getNombre()));
		Assert.assertTrue(grafo.g.get(a2.getNombre()).contains(p1.getNombre()));
		Assert.assertTrue(grafo.g.get(a3.getNombre()).contains(p1.getNombre()));
	}
	...
	public void testEstanConectadas() {
		...
		grafo.crearGrafo(SinglePeliculas.getSingle());
		// Test
		Assert.assertFalse(grafo.estanConectadas("p1", "a1"));
		...
		grafo.crearGrafo(SinglePeliculas.getSingle());
		// Test
		Assert.assertTrue(grafo.estanConectadas(p1.getNombre(), a1.getNombre()));
		...
		grafo.crearGrafo(SinglePeliculas.getSingle());
		// Test
		Assert.assertTrue(grafo.estanConectadas(p1.getNombre(), p2.getNombre()));
		...
		grafo.crearGrafo(SinglePeliculas.getSingle());
		// Test
		Assert.assertFalse(grafo.estanConectadas(a1.getNombre(), p2.getNombre()));
		// Test
		Assert.assertTrue(grafo.estanConectadas(p2.getNombre(), a2.getNombre()));
		// Test
		Assert.assertFalse(grafo.estanConectadas(p3.getNombre(), a1.getNombre()));
	}
	...
	public void testPageRank() {
		...
		grafo.crearGrafo(SinglePeliculas.getSingle());
		// Test
		Assert.assertTrue(grafo.pageRank().isEmpty());
		...
		grafo.crearGrafo(SinglePeliculas.getSingle());
		// Test
		Assert.assertTrue(grafo.pageRank().size() == 1);
		Assert.assertTrue(grafo.pageRank().get("a1") == 0.5);
		...
		/*
		 * SinglePeliculas.getSingle().vaciarLista();
		 * SingleActores.getSingle().vaciarLista(); a1 = new Actor("a1"); p1 =
		 * new Pelicula("p1"); SinglePeliculas.getSingle().insertarPelicula(p1);
		 * SingleActores.getSingle().insertarActor(a1);
		 * grafo.crearGrafo(SinglePeliculas.getSingle()); // Test
	...
	public void testTimeEstanConectadas() {
		...
		System.out.println("Se ha llamado a estanConectadas en 10 segundos: "
				+ cuenta + " veces.");
		System.out.println(timer.elapsedTime() + " segundos.\n");
		...
		System.out.println("Se ha llamado a estanConectadas en 1 minuto: "
				+ cuenta + " veces.");
		System.out.println(timer.elapsedTime() + " segundos.\n");
		...
		System.out.println("Se ha llamado a estanConectadas en 10 minutos: "
				+ cuenta + " veces.");
		System.out.println(timer.elapsedTime() + " segundos.\n");
		...
		System.out.println("Se ha llamado a estanConectadas en 30 minutos: "
				+ cuenta + " veces.");
		System.out.println(timer.elapsedTime() + " segundos.\n");
		...
		System.out.println("Se ha llamado a estanConectadas en 1 hora: "
				+ cuenta + " veces.");
		System.out.println(timer.elapsedTime() + " segundos.\n");
	}
